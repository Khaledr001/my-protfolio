...
export const personalInfo = {
  ...
  aboutParagraphs: [
    "Software Engineer with **5+ years** of experience building scalable backend and full-stack applications. Currently a **Full-Stack Developer at Sidago Inc** (Chicago, Remote), architecting headless CMS platforms with **Strapi**, **Next.js**, and **TypeScript** in a monorepo.",
